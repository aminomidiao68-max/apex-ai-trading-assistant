...
def analyze(candles_raw, symbol="", timeframe="", htf_bias=None, news_blocked=False):
    ...
    return {
        ...
        "omega_rule":{
            ...
            "max_risk_pct":1.0,"max_daily_trades":OMEGA_MAX_DAILY_TRADES,"max_weekly_trades":OMEGA_MAX_WEEKLY_TRADES,
        ...
        "order_blocks":[{"kind":o["kind"],"top":o["top"],"bottom":o["bottom"],"index":o["index"],
                          ...
                          "quality":o.get("quality",5),"fresh":not o.get("tapped",False),
                          "volume_pct":round(40.0 + o.get("quality", 5) * 6.0, 1)} for o in active_obs[-8:]],
